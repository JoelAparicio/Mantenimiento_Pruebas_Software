...
try:
    ...
    registro = WebDriverWait(driver, 5).until(EC.presence_of_element_located((By.XPATH, "/html/body/header/nav/ul/li[6]/ul/li[1]/a")))
    movimiento = ActionChains(driver)
    time.sleep(2)
    movimiento.move_to_element(usuario).move_to_element(registro).click().perform()
    time.sleep(2)
    ...
    correo = WebDriverWait(driver, 5).until(EC.presence_of_element_located((By.XPATH, "/html/body/div[1]/form/input[2]")))
    time.sleep(2)
    correo.send_keys("joel@gmail.com")
    contraseña = WebDriverWait(driver, 5).until(EC.presence_of_element_located((By.XPATH, "/html/body/div[1]/form/input[3]")))
    time.sleep(2)
    contraseña.send_keys("123456")
    registrar = WebDriverWait(driver, 5).until(EC.presence_of_element_located((By.XPATH, "/html/body/div[1]/form/input[4]")))
    time.sleep(2)
    registrar.click()
except:
